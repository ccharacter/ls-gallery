...
function ls_gallery_scripts() {
	...
	$translation_array = array( 'pluginUrl' => plugin_dir_url(__FILE__) ); //after wp_enqueue_script

	wp_localize_script( 'ls-gallery', 'jsVars', $translation_array );
